package yeoksamstationexit1.usermanage.global.config;
...
import yeoksamstationexit1.usermanage.global.jwt.JwtAuthenticationProcessingFilter;
import yeoksamstationexit1.usermanage.global.jwt.JwtService;
import yeoksamstationexit1.usermanage.global.login.CustomJsonUsernamePasswordAuthenticationFilter;
import yeoksamstationexit1.usermanage.global.login.LoginFailureHandler;
import yeoksamstationexit1.usermanage.global.login.LoginService;
import yeoksamstationexit1.usermanage.global.login.LoginSuccessHandler;
import yeoksamstationexit1.usermanage.global.oauth.CustomOAuth2UserService;
import yeoksamstationexit1.usermanage.global.oauth.OAuth2LoginFailureHandler;
import yeoksamstationexit1.usermanage.global.oauth.OAuth2LoginSuccessHandler;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers("/", "/sign-up", "/css/**", "/images/**", "/js/**", "/favicon.ico",
            "/v3/api-docs/**", "/swagger-ui/**","/api/room/**","/user-manage/room/tolivemap")
        .permitAll()
